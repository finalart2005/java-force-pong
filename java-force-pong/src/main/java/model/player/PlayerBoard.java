...
import model.Game;
import model.entity.PhysicalEntity;
...
public class PlayerBoard implements PhysicalEntity {
	
	private VectXY		pos, vel;
	private Set<Force>	forceSet;
	private Game		game;
	
	public PlayerBoard(VectXY pos, Game game) {}
	
	public PlayerBoard(VectXY pos, VectXY vel, Set<Force> forceSet, Game game) {
		this.pos = pos;
		this.vel = vel;
